// src/components/sections/DashHero.tsx
...
const METRICS = [
    { value: "60fps", label: "UI Render-Rate" },
    { value: "< 100ms", label: "Interaction Response" },
    { value: "RBAC", label: "Role-Based Access" },
    { value: "BI-Grade", label: "Analytics-Tiefe" },
];
...
export default function DashHero() {
    return (
        ...
        >
            ...
            >
                <span className="text-[clamp(5rem,18vw,18rem)] font-black uppercase tracking-[-0.04em] text-[#000000] opacity-[0.03] select-none whitespace-nowrap leading-none">
                    DASH
                </span>
            </div>
