        ...
        >
            <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
                ...
                <div>
                    <Link
                        href="/careers"
                        className="inline-flex items-center justify-center bg-[#000000] text-[#FFFFFF] px-10 py-5 text-[11.5px] font-black tracking-[0.3em] uppercase hover:bg-[#001F3F] transition-colors duration-300 min-h-14"
                    >
