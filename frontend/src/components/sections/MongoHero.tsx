// src/components/sections/MongoHero.tsx
...
const METRICS = [
    ...
    { value: "∞", label: "Horizontale Skalierung" },
    { value: "ACID", label: "Transaktions-Garantie" },
];

export default function MongoHero() {
    return (
        <section
            aria-labelledby="mongo-hero-heading"
        ...
        >
            ...
            >
                <span className="text-[clamp(5rem,16vw,16rem)] font-black uppercase tracking-[-0.04em] text-[#000000] opacity-[0.025] select-none whitespace-nowrap leading-none">
                    MONGODB
                </span>
            </div>
