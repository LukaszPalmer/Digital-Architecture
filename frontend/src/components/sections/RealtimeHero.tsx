// src/components/sections/RealtimeHero.tsx
...
export default function RealtimeHero() {
    return (
        <section
            aria-labelledby="realtime-hero-heading"
                    ...
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <div className="bg-[#001F3F] px-3 py-1.5">
                            <span className="text-[10px] font-mono font-black tracking-[0.4em] text-[#FFFFFF] uppercase">
                                SYS_08_REALTIME // Echtzeit-Kommunikation
                            </span>
                        </div>
                    </div>
                </ScrollReveal>
                ...
                <ScrollReveal delay={200}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-[#000000]/10 pt-10 mb-0">
                        <p className="text-[17px] md:text-[19px] leading-relaxed text-[#000000]/70 border-l-2 border-[#001F3F] pl-6 max-w-lg">
                            ...
                            und bidirektionale Echtzeit-Kommunikation — mit Socket.IO und
                            Node.js. Wir bauen Kommunikationssysteme, die sich so schnell
                            anfuehlen wie ein persoenliches Gespraech. Fuer Marktplaetze,
                            Plattformen und Unternehmen in Duesseldorf und ganz Deutschland.
                        </p>
