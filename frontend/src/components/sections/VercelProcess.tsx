// src/components/sections/VercelProcess.tsx
...
const PROCESS_STEPS = [
    ...
    {
        step: "02",
        title: "Rendering Strategy Design",
        description:
    ...
    {
        step: "04",
        title: "Lighthouse 100 Verifizierung",
        description:
...
export default function VercelProcess() {
    return (
        <section
            aria-labelledby="vercel-process-heading"
                ...
                <ScrollReveal>
                    <div className="mb-16 md:mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                        ...
                        <p className="text-[15px] text-[#FFFFFF]/65 leading-relaxed max-w-sm border-l-2 border-[#FFFFFF]/25 pl-6">
                            Vier Schritte vom bestehenden System zum optimierten,
                            global verteilten Vercel-Deployment — in unter fünf
                            Tagen abgeschlossen.
                        </p>
                    </div>
                </ScrollReveal>
