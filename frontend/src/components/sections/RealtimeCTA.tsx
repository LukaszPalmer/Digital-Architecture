// src/components/sections/RealtimeCTA.tsx
...
const RT_SPECS = [
    { label: "Event-Latenz", value: "< 1ms End-to-End" },
    { label: "Concurrent", value: "1M+ Verbindungen" },
    { label: "Protokoll", value: "WSS Encrypted" },
    { label: "Skalierung", value: "Redis Horizontal" },
];

export default function RealtimeCTA() {
    return (
        <section
            aria-labelledby="realtime-cta-heading"
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-16">
                        ...
                        <div className="max-w-2xl">
                            <span className="text-[10px] font-mono font-bold tracking-[0.5em] text-[#FFFFFF]/40 uppercase block mb-8">
                                [ Jetzt Echtzeit-Kommunikation implementieren ]
                            </span>
                            <h2
                                id="realtime-cta-heading"
                            ...
                            <p className="text-[15px] text-[#FFFFFF]/65 leading-relaxed max-w-lg border-l-2 border-[#FFFFFF]/20 pl-5">
                                Wir analysieren Ihre Plattform, definieren die
                                Event-Architektur und bauen ein Echtzeit-System,
                                das sich so schnell anfuehlt wie ein persoenliches
                                Gespraech — mit Socket.IO, Redis-Skalierung und
                                DSGVO-konformer Infrastruktur. Aus Duesseldorf,
                                fuer Unternehmen in ganz Deutschland.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-4 shrink-0 min-w-72">
                            ...
                            >
                                <span>Kostenlose Architektur-Beratung</span>
