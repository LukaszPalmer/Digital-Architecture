// src/components/sections/NodeProcess.tsx
...
export default function NodeProcess() {
    return (
        <section
            aria-labelledby="node-process-heading"
                ...
                <ScrollReveal>
                    <div className="mb-16 md:mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                        ...
                        <p className="text-[15px] text-[#FFFFFF]/65 leading-relaxed max-w-sm border-l-2 border-[#FFFFFF]/25 pl-6">
                            Vier Phasen vom API-Contract-Design bis zum
                            produktiven Node.js-Backend mit vollständiger
                            Observability und Load-verifizierter Performance.
                        </p>
                    </div>
                </ScrollReveal>
