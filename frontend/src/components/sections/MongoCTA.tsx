// src/components/sections/MongoCTA.tsx
...
const CLUSTER_SPECS = [
    { label: "Database", value: "MongoDB Atlas M30+" },
    { label: "Replication", value: "3-Node Replica Set" },
    { label: "Uptime Guarantee", value: "99.99% SLA" },
    { label: "Failover", value: "< 30s Automatic" },
];

export default function MongoCTA() {
    return (
        <section
            aria-labelledby="mongo-cta-heading"
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-16">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <p className="text-[15px] text-[#FFFFFF]/65 leading-relaxed max-w-lg border-l-2 border-[#FFFFFF]/20 pl-5">
                                Wir designen, migrieren und optimieren deine
                                MongoDB-Infrastruktur — von der Shard-Key-Strategie
                                bis zum produktionsreifen Atlas-Cluster mit
