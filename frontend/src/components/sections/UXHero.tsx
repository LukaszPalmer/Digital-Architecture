// src/components/sections/UXHero.tsx
...
export default function UXHero() {
    return (
        ...
        >
            ...
            >
                <span className="text-[clamp(4rem,15vw,15rem)] font-black uppercase tracking-[-0.04em] text-[#000000] opacity-[0.03] select-none whitespace-nowrap leading-none">
                    DESIGN
                </span>
            </div>
