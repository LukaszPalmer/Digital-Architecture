// src/components/sections/PostgreHero.tsx
...
const METRICS = [
    { value: "ACID", label: "Vollständige Garantie" },
    { value: "< 5ms", label: "Lokale Query-Latenz" },
    { value: "MVCC", label: "Concurrency Control" },
    { value: "99.9%", label: "Uptime SLA" },
];

export default function PostgreHero() {
    return (
        <section
            aria-labelledby="postgre-hero-heading"
        ...
        >
            ...
            >
                <span className="text-[clamp(4rem,14vw,14rem)] font-black uppercase tracking-[-0.04em] text-[#000000] opacity-[0.025] select-none whitespace-nowrap leading-none">
                    POSTGRESQL
                </span>
            </div>
                ...
                <ScrollReveal delay={200}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-[#000000]/10 pt-10 mb-0">
                        <p className="text-[17px] md:text-[19px] leading-relaxed text-[#000000]/70 border-l-2 border-[#001F3F] pl-6 max-w-lg">
                            PostgreSQL ist die relationale Datenbankschicht aller
                            PDA-Systeme, die strukturierte Datenintegrität erfordern.
                            Volltextsuche, Row-Level Security, JSON-Unterstützung
                            und ACID-Garantien — gebaut für transaktionskritische
                            Produktivsysteme ohne Kompromisse.
                        </p>
