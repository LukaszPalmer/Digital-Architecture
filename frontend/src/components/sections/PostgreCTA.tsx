// src/components/sections/PostgreCTA.tsx
...
const DB_SPECS = [
    ...
    { label: "Backup", value: "pgBackRest PITR" },
    { label: "Monitoring", value: "pg_stat + Prometheus" },
];

export default function PostgreCTA() {
    return (
        <section
            aria-labelledby="postgre-cta-heading"
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-16">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <p className="text-[15px] text-[#FFFFFF]/65 leading-relaxed max-w-lg border-l-2 border-[#FFFFFF]/20 pl-5">
                                ...
                                PostgreSQL-Infrastruktur — vom Schema-Audit über
                                Row-Level Security bis zum produktionsreifen
                                Cluster mit vollständigem PITR-Backup und Monitoring.
                            </p>
                        </div>
